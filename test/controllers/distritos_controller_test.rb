...
class DistritosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create distrito" do
    assert_difference('Distrito.count') do
      post distritos_url, params: { distrito: { nombre_distrito: @distrito.nombre_distrito } }
    end
  ...
  test "should update distrito" do
    patch distrito_url(@distrito), params: { distrito: { nombre_distrito: @distrito.nombre_distrito } }
