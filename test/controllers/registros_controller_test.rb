...
class RegistrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registro" do
    assert_difference('Registro.count') do
      post registros_url, params: { registro: { distrito_id: @registro.distrito_id, enlace: @registro.enlace, nombre_calle_id: @registro.nombre_calle_id, padron_id: @registro.padron_id, pagina_fin: @registro.pagina_fin, pagina_inicio: @registro.pagina_inicio } }
    end
  ...
  test "should update registro" do
    patch registro_url(@registro), params: { registro: { distrito_id: @registro.distrito_id, enlace: @registro.enlace, nombre_calle_id: @registro.nombre_calle_id, padron_id: @registro.padron_id, pagina_fin: @registro.pagina_fin, pagina_inicio: @registro.pagina_inicio } }
